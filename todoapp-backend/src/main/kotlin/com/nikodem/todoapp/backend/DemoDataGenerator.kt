...
class DemoDataGenerator(
    ...
    override fun run(vararg args: String?) {
        ...
        val user = userService.save(PostUserDTO("Adam", "Jakistam", "AdamJ", "pass123123", "adamk@gmail.com"))
        val user1 = userService.save(PostUserDTO("Krzysztof", "Ktostam", "KrzysztofK", "pass321", "krzysztofk@gmail.com"))
